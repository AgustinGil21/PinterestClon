import { getUserAccountManagementCase } from '../../application/use-cases/user-edit/getUserAccountManagement';
import {
  UserDataAccountEdit,
  UserPublicData,
...
import { getUserLoggedCase } from '../../application/use-cases/user-edit/getUserLogged';
import { putUserSettingsEditProfileCase } from '../../application/use-cases/user-edit/putUserSettingEditProfile';
import { deleteUserAccountCase } from '../../application/use-cases/user-edit/deleteUserAccount';
import { getUserSettingsEditProfileCase } from '../../application/use-cases/user-edit/getUserSettingsEditProfile';
import { putUserAccountManagementCase } from '../../application/use-cases/user-edit/putUserAccountManagement.';
import { getProfileVisibilityCase } from '../../application/use-cases/user-edit/getProfileVisibility';
import { patchProfileVisibilityPrivateCase } from '../../application/use-cases/user-edit/patchProfileVisibilityPrivate';
import { patchProfileVisibilityTypeCase } from '../../application/use-cases/user-edit/patchProfileVisibilityType';
import { patchAccountManagementCase } from '../../application/use-cases/user-edit/patchAccountManagementPassword';
import { patchAvatarCase } from '../../application/use-cases/user-edit/patchAvatar';
import { deleteAvatarCase } from '../../application/use-cases/user-edit/deleteAvatar';
