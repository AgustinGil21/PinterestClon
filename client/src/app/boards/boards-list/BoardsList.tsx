  ...
  return (
    <>
      <section className='w-full pt-4 flex flex-col items-center'>
        ...
        <footer
          onClick={handleClick}
          className='w-full h-[80px] p-[1rem_0.8rem] hover:bg-[#e9e9e9] rounded-b-2xl flex gap-2 items-center cursor-pointer font-semibold  boards-list-shadow hover:shadow-none'
        >
          <ButtonStyled className='flex flex-row items-center gap-3 !p-0'>
            {' '}
