...
import { changePasswordSchema, editPersonalInfoSchema, newPasswordSchema, } from '../schemas/account-management.schema.js';
export default class AccountManagementController {
    ...
    static async changePersonalInfo(req, res) {
        ...
        try {
            const { emailAddress, birthdate, gender, country, language } = userDataObject;
