...
import { registerSchema, loginSchema, resetPasswordSchema, recoverAccountSchema, checkEmailAddressSchema, } from '../schemas/auth.schema.js';
...
export default class AuthController {
    ...
    static async register(req, res) {
        let avatar;
        const { password, emailAddress, birthdate, username, genderId, countryId, langId, avatarBackground, avatarLetterColor, avatarLetter, } = req.body;
        try {
        ...
        if (req.files?.avatar) {
            const result = await uploadFileToCloudinary(req.files.avatar.tempFilePath);
